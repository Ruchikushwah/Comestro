     ...
     <div class=" w-full ">
         <div class="flex justify-between p-6 bg-[#f0f4ff] font-sans  w-full">
             ...
             <div class="w-[400px] p-6 bg-white rounded-lg shadow-md">
                 ...
                 <p class="text-sm text-[#555] mb-4">Born out of a vision, a single-minded objective that puts service before anything else, Swift Clearance and Forwarding Corp. surging forth to deliver the best services in the shipping and logistics scenario...</p>
                 <a href="#" class="text-[#ff6b6b] font-semibold">Read more</a>
             </div>
         </div>
     </div>
