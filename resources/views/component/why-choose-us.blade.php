    ...
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div class="flex justify-center">
                <img src="Rectangle 18.png" alt="Why Choose Us" class="max-w-full h-auto rounded-lg ">
            </div>
        ...
        <div class="mt-10 text-center md:text-left">
            ...
            <button class="mt-6 bg-[#0071bc] text-white px-4 py-3 rounded hover:bg-[#0071bc] text-lg transition duration-300">
