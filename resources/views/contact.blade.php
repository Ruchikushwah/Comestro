                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center sm:justify-start">
                        <div class="flex flex-col items-center sm:flex-row sm:items-start space-x-0 sm:space-x-4 text-center sm:text-left">
                            <img src="/contact/location.png" alt="Location Image" class="w-15 h-15 sm:w-15 sm:h-15 mb-4 sm:mb-0">
                            <div>
                        ...
                        <div class="flex flex-col items-center sm:flex-row sm:items-start space-x-0 sm:space-x-4 text-center sm:text-left">
                            <img src="/contact/email.png" alt="Email Image" class="w-15 h-15 sm:w-15 sm:h-15 mb-4 sm:mb-0">
                            <div>
                        ...
                        <div class="flex flex-col items-center sm:flex-row sm:items-start space-x-0 sm:space-x-4 text-center sm:text-left">
                            <img src="/contact/phone.png" alt="Phone Image" class="w-15 h-15 sm:w-15 sm:h-15 mb-4 sm:mb-0">
                            <div>
                        ...
                        <div class="flex flex-col items-center sm:flex-row sm:items-start space-x-0 sm:space-x-4 text-center sm:text-left">
                            <img src="/contact/whatapp.png" alt="WhatsApp Image" class="w-15 h-15 sm:w-15 sm:h-15 mb-4 sm:mb-0">
                            <div>
