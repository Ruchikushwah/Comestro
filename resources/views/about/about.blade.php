...
<div>
    <div class="w-full ">
        <div>
            <img src="\02-image-free-img.jpg" alt="" class="w-full">
        </div>
    </div>
    ...
    <div class="w-full ">
        <div>
            <img src="\software.png" alt="" class="w-full">
        </div>
    </div>
</div>
<div class="bg-white pB-12 overflow-x-hidden">
    ...
    <div class="bg-white py-12 px-4 text-center">
        ...
        <p class="text-3xl font-bold text-gray-800">
            Comestro Pravate Limitted offer end-to-end 'Software solutions'
        </p>
                ...
                <div class="flex-shrink-0 w-full sm:w-1/2 lg:w-1/3 px-2 sm:px-4 lg:px-5 flex">
                    <div class="flex flex-col items-center">
                        ...
                        <div class="w-32 h-32 rounded-full overflow-hidden mb-4">
                            <img src="https://picsum.photos/200/300" alt="Profile Image" class="w-full h-full object-cover">
                        </div>
                    </div>
                </div>
