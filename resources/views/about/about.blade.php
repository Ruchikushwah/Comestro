    ...
    <div class="flex w-full lg:px-10">
        <div class="lg:w-2/3 lg:pl-12 p-8 rounded">
            <h1 class="mb-6 font-bold text-2xl lg:text-3xl flex flex-col lg:flex-row items-center">
                ...
                <a href="#" class="text-blue-600 ml-2">Chief Executive Officer - TechNova Solutions</a>
            </h1>
...
<div class="flex flex-col px-6 lg:px-16 py-10">
    <h2 class="text-4xl text-center mb-8">Meet Our Team</h2>
