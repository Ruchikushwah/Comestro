            ...
            <h1 class="text-2xl font-bold text-gray-800 mb-4">Sign Up Here...</h1>
             <form action="" method="POST" class=" gap-4 mt-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" placeholder="Full name" class="w-full border  rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500">
                </div>
                <div>
